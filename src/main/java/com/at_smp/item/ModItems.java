...
public class ModItems {
    ...
    public static final DeferredItem<Item> METEORITE_HELMET = ITEMS.register("meteorite_helmet", properties -> new ArmorItem(ModArmorMaterials.METEORITE, ArmorItem.Type.HELMET, new Item.Properties().component(DataComponents.FIRE_RESISTANT, Unit.INSTANCE).durability(ArmorItem.Type.HELMET.getDurability(45))));
    ...
    public static final DeferredItem<Item> METEORITE_LEGGINGS = ITEMS.register("meteorite_leggings", properties -> new ArmorItem(ModArmorMaterials.METEORITE, ArmorItem.Type.LEGGINGS, new Item.Properties().component(DataComponents.FIRE_RESISTANT, Unit.INSTANCE).durability(ArmorItem.Type.LEGGINGS.getDurability(45))));
    public static final DeferredItem<Item> METEORITE_BOOTS = ITEMS.register("meteorite_boots", properties -> new ArmorItem(ModArmorMaterials.METEORITE, ArmorItem.Type.BOOTS, new Item.Properties().component(DataComponents.FIRE_RESISTANT, Unit.INSTANCE).durability(ArmorItem.Type.BOOTS.getDurability(45))));
    ...
    public static final DeferredItem<Item> PLACE_HOLDER_MUSIC_DISC = ITEMS.register("place_holder_music_disc", () -> new Item(new Item.Properties()));
