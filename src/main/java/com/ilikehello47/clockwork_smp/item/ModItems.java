...
public class ModItems {
    ...
    // Phone item used for tapping instead of spending physical diamonds
    public static final DeferredItem<Item> PHONE_ITEM = ITEMS.register("alipay_phone_item", () -> new com.ilikehello47.clockwork_smp.alipay.PhoneItem(new Item.Properties().stacksTo(1)));
}
